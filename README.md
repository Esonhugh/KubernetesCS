...
[English Version](./kubernetes-cs-en-US.md)

[Chinese Version](./kubernetes-cs-zh-CN.md)
...
In this case, by analyzing the base64-encoded client-certificate-data, specific information about the issuing administrator can be obtained.
